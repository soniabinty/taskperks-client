...
const AllTasks = () => {
  ...
  return (
    <div className="container mx-auto lg:p-6  py-12">
      <h1 className="text-3xl font-bold text-center mb-8 text-black mt-16">All Available Tasks</h1>
      ...
      <div className="grid gap-6 sm:grid-cols-3 lg:grid-cols-4 lg:px-4">
        {tasks
          .filter((task) => task.workers > 0)  // This can be removed if backend handles all filtering
          .map((task) => (
            <div
              key={task._id}
